    ...
    <main className="bg-gray-100 w-[90vw] max-w-screen-lg mx-auto mt-12 p-10 rounded-lg shadow-xl">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Add to Cart Button */}
          <div className="mt-4">
            <button className="w-full flex items-center justify-center gap-2 py-3 bg-black text-white rounded-lg font-bold text-sm transition-colors hover:bg-gray-900">
              <svg
